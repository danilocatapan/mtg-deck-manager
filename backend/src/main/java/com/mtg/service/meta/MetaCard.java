...
public class MetaCard {
    ...
    public MetaCard(String name, double inclusion, String role, Double avgCmc, double bracketWeight, double performanceWeight, List<String> synergyTags, String source) {
        this(name, inclusion, role, avgCmc, 0, bracketWeight, performanceWeight, synergyTags, source);
    }

    public MetaCard(String name, double inclusion, String role, Double avgCmc, int count, double bracketWeight, double performanceWeight, List<String> synergyTags, String source) {
        this.name = name;
        this.inclusion = inclusion;
        this.role = role;
        this.avgCmc = avgCmc;
    ...
    public MetaCard withBracketWeight(double weight, double performanceWeight, String source) {
        return new MetaCard(name, inclusion, role, avgCmc, count, weight, performanceWeight, getSynergyTags(), source);
    }
}
